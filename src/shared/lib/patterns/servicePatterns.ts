...
/**
 * Common validation patterns used across features
 */
export class CommonValidation {
  static readonly REGION_PATTERN = /^[a-z0-9]+$/;
  static readonly SUMMONER_NAME_PATTERN = /^[a-zA-Z0-9_\s]+$/;
  static readonly PUUID_LENGTH = 78;
