              ...
              {tabs.map((tab, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <motion.div
                      className={`relative z-10 ${isActive ? tab.color : 'text-base-content/40'}`}
                      animate={{ 
                    ...
                    {/* Hover effect */}
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                      initial={false}
                    />
                    ...
                    {isActive && (
                      <motion.div
                        className={`absolute -top-1 left-1/2 w-2 h-2 rounded-full ${tab.color.replace('text-', 'bg-')}`}
