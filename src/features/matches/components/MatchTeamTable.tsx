    ...
    >
      <td className="p-3 pl-4 font-semibold text-base-content min-w-[120px] max-w-[220px]">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <Link
              href={profileUrl}
              className="hover:text-primary transition-colors duration-200 max-w-[110px] font-bold text-sm truncate"
      ...
      <td className="min-w-[70px] max-w-[120px]">
        <motion.span
          ...
          className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-info/20 to-info/10 text-info border border-info/30 font-mono text-sm font-bold rounded-full shadow-sm"
        >
          {player.kda}
        </motion.span>
      </td>
      ...
      <td className="min-w-[60px] text-left">
        <motion.span
          whileHover={{ scale: 1.05 }}
          className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-error/20 to-error/10 text-error border border-error/30 font-mono text-sm font-bold rounded-full shadow-sm"
        >
          {player.damage}
        </motion.span>
      </td>
      ...
      <td className="min-w-[60px] text-left">
        <motion.span
          whileHover={{ scale: 1.05 }}
          className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-success/20 to-success/10 text-success border border-success/30 font-mono text-sm font-bold rounded-full shadow-sm"
        >
          {player.gold}
        </motion.span>
      </td>
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-3xl shadow-2xl bg-gradient-to-br 
        ...
        border-2 backdrop-blur-md mb-6 hover:shadow-3xl transition-all duration-500`}
    >
      ...
      >
        ...
        {teamStats && (
          ...
          >
            <motion.span
              whileHover={{ scale: 1.05 }}
              className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-primary/20 to-primary/10 text-primary border border-primary/30 font-bold text-sm rounded-full shadow-lg"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <motion.span
              whileHover={{ scale: 1.05 }}
              className="inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-warning/20 to-warning/10 text-warning border border-warning/30 font-bold text-sm rounded-full shadow-lg"
            >
              <svg
                className="w-4 h-4"
                fill="none"
