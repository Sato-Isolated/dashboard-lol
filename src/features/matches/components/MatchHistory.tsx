          ...
          {statsCards.map((card, index) => {
            ...
            return (
              <motion.div
                ...
                variants={statsCardVariants}
                whileHover="hover"
                className={`bg-gradient-to-r ${card.gradient} rounded-xl p-4 border border-base-300/50 cursor-pointer transition-all duration-300 hover:border-base-300 hover:shadow-lg backdrop-blur-sm`}
              >
                <div className="flex items-center space-x-3">
                  <motion.div
