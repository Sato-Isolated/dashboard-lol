...
export const ChampionCard: React.FC<ChampionCardProps> = ({
  ...
  if (variant === "compact") {
    return (
      <div
        className={`card bg-base-200 rounded-xl shadow hover:shadow-lg transition-all duration-200 p-3 ${
  ...
  if (variant === "detailed") {
    return (
      <div
        className={`card bg-base-200 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 p-6 ${
          onClick ? "cursor-pointer hover:scale-[1.02]" : ""
        }`}
        onClick={onClick}
      >
  ...
  return (
    <div
      className={`card bg-base-200 rounded-xl shadow hover:shadow-lg transition-all duration-200 p-4 ${
        onClick ? "cursor-pointer hover:scale-[1.02]" : ""
      }`}
      onClick={onClick}
    >
