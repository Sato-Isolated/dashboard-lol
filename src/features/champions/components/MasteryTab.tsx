...
const MasteryCard: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br ${masteryStyle.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-2xl`}
      ></div>

      {/* Card content */}
      <div className="relative p-6 border border-base-300/50 rounded-2xl backdrop-blur-sm bg-base-100/80 group-hover:border-primary/50 transition-all duration-300 shadow-lg group-hover:shadow-2xl">
        {/* Rank indicator */}
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          >
            {/* Avatar glow */}
            <div
              className={`absolute inset-0 bg-gradient-to-br ${masteryStyle.gradient} rounded-2xl blur-lg opacity-0 group-hover/avatar:opacity-60 transition-opacity duration-300`}
            ></div>
            ...
            <Image
              ...
              width={80}
              height={80}
              className="relative w-20 h-20 rounded-2xl border-3 border-primary/30 group-hover:border-primary/60 transition-all duration-300 shadow-xl"
            />
          ...
          {/* Champion name */}
          <motion.h3
            className="font-bold text-lg text-base-content group-hover:text-primary transition-colors duration-300 truncate w-full"
...
const MasteryListRow: React.FC<{
  ...
  return (
    <motion.tr
      ...
      className="group border-b border-base-300/50 hover:border-primary/30 transition-all duration-300"
    >
      {/* Champion */}
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Image
              ...
              width={48}
              height={48}
              className="w-12 h-12 rounded-xl border-2 border-primary/30 group-hover:border-primary/60 transition-colors duration-300 shadow-lg"
            />
            <div
...
const MasteryTab: React.FC = React.memo(() => {
  ...
  const masteryStats = useMemo(() => {
    ...
    const level7Champions = masteries.filter(
      (m) => m.championLevel >= 7
    ).length;
