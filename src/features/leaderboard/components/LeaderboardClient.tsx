        ...
        <div className="container mx-auto px-4 py-8">
          ...
          >
            <motion.div
              ...
              className="card bg-gradient-to-r from-warning/20 to-yellow-500/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
            ...
            <motion.div
              ...
              className="card bg-gradient-to-r from-primary/20 to-blue-500/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
              <div className="card-body items-center text-center">
            ...
            <motion.div
              ...
              className="card bg-gradient-to-r from-secondary/20 to-purple-500/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
              <div className="card-body items-center text-center">
            ...
            <motion.div
              ...
              className="card bg-gradient-to-r from-accent/20 to-green-500/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
            >
              <div className="card-body items-center text-center">
